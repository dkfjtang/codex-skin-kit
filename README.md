...
<p align="center">
  基于 <a href="https://github.com/Fei-Away/Codex-Dream-Skin"><strong>Fei-Away/Codex-Dream-Skin</strong></a> 的低分叉跟随版。<br>
  本仓主要做中文整理、Windows/macOS 使用入口、支持服务展示与上游鸣谢；核心换肤能力尽量跟随上游。
</p>
...
Flowdeck 是上游项目 [Fei-Away/Codex-Dream-Skin](https://github.com/Fei-Away/Codex-Dream-Skin) 的轻量二次整理版。上游提供了主要的 Windows/macOS 换肤脚本、主题注入、预设、验证与恢复能力。

本仓维护策略是：

- 核心脚本尽量不改，降低长期维护成本
- 本地差异集中在 README、支持服务、仓库说明、鸣谢和少量品牌资源
- 后续功能优先从上游同步，而不是在本仓独立演进
- 上游作者、贡献者、许可证和来源信息保留在公开页面与通知文件中
