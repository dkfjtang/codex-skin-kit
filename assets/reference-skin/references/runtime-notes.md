...
- State and logs live under `~/Library/Application Support/FlowDeckSignalGarden`.
- The installer copies the entire skill to `~/.codex/skills/flowdeck-signal-garden`; desktop launchers point to this stable path.
...
- Environment overrides are `FLOWDECK_SIGNAL_GARDEN_APP_PATH`, `FLOWDECK_SIGNAL_GARDEN_NODE`, `FLOWDECK_SIGNAL_GARDEN_STATE_ROOT`, `FLOWDECK_SIGNAL_GARDEN_CONFIG_PATH`, and `FLOWDECK_SIGNAL_GARDEN_DESKTOP_DIR`.
