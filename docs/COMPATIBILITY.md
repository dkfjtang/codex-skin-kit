...
FlowDeck v0.1.0 is scoped to macOS desktop application builds that expose Chromium DevTools Protocol targets on `127.0.0.1` when launched with a local debugging port.
