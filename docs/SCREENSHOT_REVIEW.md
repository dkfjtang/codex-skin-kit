...
This file is the publication gate for any README preview image that is not generated by this repository's own macOS verification flow.
...
- README wording: the current preview section is intentionally empty and must not describe any image as a locally verified runtime screenshot.

## Required Before Using A Third-Party Screenshot

Record all items below before adding a third-party image to the README preview section.
